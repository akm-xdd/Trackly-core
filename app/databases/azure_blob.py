...
class AzureBlobClient:
    ...
    def __init__(self):
        ...
        if self.connection_string:
            ...
            raise ValueError("Either AZURE_STORAGE_CONNECTION_STRING or AZURE_STORAGE_ACCOUNT_KEY is required")
    ...
    def upload_file(self, file_content: BinaryIO, filename: str, uploaded_by: str, content_type: str = None) -> str:
